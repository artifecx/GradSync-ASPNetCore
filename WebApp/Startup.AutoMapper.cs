        ...
        private sealed class AutoMapperProfileConfiguration : Profile
        {
            public AutoMapperProfileConfiguration()
            {
                ...
                CreateMap<JobViewModel, Job>()
                    ...
                    .ForMember(dest => dest.SalaryLower, opt => opt.Ignore())
                    .ForMember(dest => dest.SalaryUpper, opt => opt.Ignore())
                    ...
                    .ForMember(dest => dest.Salary, opt => opt.MapFrom(src => $"Php {src.SalaryLower} - Php {src.SalaryUpper}"))
                ...
                CreateMap<JobApplicantMatch, FeaturedJobsViewModel>()
                    ...
                    .ForMember(dest => dest.Salary, opt => opt.MapFrom(src => $"Php {src.Job.SalaryLower} - Php {src.Job.SalaryUpper}"))
